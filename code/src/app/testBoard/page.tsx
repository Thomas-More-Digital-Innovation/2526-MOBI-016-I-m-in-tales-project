      ...
      <div className="max-w-2xl mx-auto py-12 px-6">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="relative group">
            <div className={`relative bg-white border-4 ${tagContent ? 'border-talesorang-500 shadow-[0_0_20px_rgba(246,116,94,0.3)]' : 'border-talesblu-100'} rounded-2xl p-10 min-h-64 flex flex-col items-center justify-center text-center transition-all duration-300`}>
              {tagContent ? (
                ...
                <div className="text-talesblu-300">
                  ...
                  <p className="text-xl font-bold mb-1">Waiting for Tag...</p>
                </div>
              )}
            </div>
          </div>
